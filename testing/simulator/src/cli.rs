        ...
        .subcommand(
            ...
            .about(
                "Lighthouse Beacon Chain Simulator creates `n` beacon node and validator clients, \
                    ...
                    .arg(Arg::with_name("nym-nodes")
                        .short("nn")
                        .long("nym-nodes")
                        .takes_value(true)
                        .default_value("1")
                         .help("Number of beacon nodes with nym transport"))
                    .arg(Arg::with_name("tcp-nodes")
                        .short("tn")
                        .long("tcp-nodes")
                        .takes_value(true)
                        .default_value("2")
                         .help("Number of beacon nodes with tcp transport"))
                    .arg(Arg::with_name("either-nodes")
                        .short("en")
                        .long("either-nodes")
                        .takes_value(true)
                        .default_value("0")
                        .help("Number of beacon nodes with transport nym either trp"))
                    .arg(Arg::with_name("leading-node")
                        .short("l")
                        .long("leading-node")
                        .takes_value(true)
                        .default_value("nym-either-tcp")
                        .help("the main node of the network"))
